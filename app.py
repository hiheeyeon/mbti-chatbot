...
mbti_destinations = {
    "ISTJ": {
        ...
        "food_area": "황리단길 일대 한식·카페 거리",
        "food_menu": "경주 황남빵, 교동쌈밥 황리단길점, 원조떡갈비, 양지다방(카페)"
    },
    "ISFJ": {
        "country": "대한민국",
        "city": "전주 한옥마을",
        ...
        "food_area": "전주 한옥마을·남부시장 근처",
        "food_menu": "호남각(전주비빔밥), 현대옥(콩나물국밥), 자매갈비(갈비전골)"
    },
    "INFJ": {
        "country": "대한민국",
        "city": "담양",
        ...
        "food_area": "담양 관방제림·죽녹원 인근",
        "food_menu": "한상근대통밥집, 담양갈비창고(떡갈비), 담양막둥이국수(죽순비빔국수)"
    },
    "INTJ": {
        "country": "대한민국",
        "city": "제주 우도",
        ...
        "food_area": "우도 해안도로 카페·식당",
        "food_menu": "피넛캬라멜하우스(땅콩빙수), 우도해녀식당(해물요리), 섬소나이(전복짬뽕)"
    },
    "ISTP": {
        "country": "대한민국",
        "city": "강원도 속초·설악산",
        ...
        "food_area": "속초 중앙시장·대포항 일대",
        "food_menu": "황부자튀김(아바이순대, 오징어순대, 튀김), 속초항아리물회"
    },
    "ISFP": {
        "country": "대한민국",
        "city": "여수",
        ...
        "food_area": "여수 엑스포역·돌산대교 인근",
        "food_menu": "꽃돌게장1번가(간장게장), 삼학집(서대회무침), 순이네밥상(갈치조림), 삼합당 본점(딸기모찌)"
    },
    "INFP": {
        "country": "대한민국",
        "city": "통영",
        ...
        "food_area": "통영 중앙시장·항구 주변",
        "food_menu": "뚱보할매김밥집(충무깁밥), 대풍관(물회), 동피랑쭈글(굴 요리)"
    },
    "INTP": {
        "country": "대한민국",
        "city": "춘천",
        ...
        "food_area": "명동 닭갈비골목 일대",
        "food_menu": "춘천통나무집닭갈비, 메바우명가춘천막국수"
    },
    "ESTP": {
        "country": "대한민국",
        "city": "부산 해운대·광안리",
        ...
        "food_area": "해운대 시장·광안리 해변가",
        "food_menu": "할매집(돼지국밥), 광안리 대교밀면, 개미집(낙곱새)"
    },
    "ESFP": {
        "country": "대한민국",
        "city": "제주도",
        ...
        "food_area": "제주시 연동·애월·함덕 카페거리",
        "food_menu": "숙성도(흑돼지 구이), 자매국수(고기국수), 형제도식당(갈치구이)"
    },
    "ENFP": {
        "country": "대한민국",
        "city": "강릉·양양",
        ...
        "food_area": "강릉 안목해변 카페거리·포남시장",
        "food_menu": "초당훈이순두부짬뽕, 벌집 (칼국수), 테라로사(커피)"
    },
    "ENTP": {
        "country": "대한민국",
        "city": "서울 성수",
        ...
        "food_area": "성수 카페·맛집 거리",
        "food_menu": "차일디쉬(소금빵X붕어빵), 소문난성수감자탕"
    },
    "ESTJ": {
        "country": "대한민국",
        "city": "경복궁",
        ...
        "food_area": "광장시장·남대문시장·종로 일대",
        "food_menu": "광장시장 빈대떡, 원조정할머니기름떡볶이, 스태픽스(카페)"
    },
    "ESFJ": {
        "country": "대한민국",
        "city": "인천·송도",
        ...
        "food_area": "송도 센트럴파크·연수동 카페거리",
        "food_menu": "송도 수블라키아(그리스 음식), 왔다갔다황소곱창, 조개드림 피쉬(조개구이)"
    },
    "ENFJ": {
        "country": "대한민국",
        "city": "남해·거제",
        ...
        "food_area": "남해 독일마을·상주·미조항 인근",
        "food_menu": "강성횟집, 산봉쌈밥(멸치쌈밥)"
    },
    "ENTJ": {
        "country": "대한민국",
        "city": "세종",
        "img_url": "https://images.unsplash.com/photo-1662360370306-0b17fa7ea02f?q=80&w=1239&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        "style": "계획적·도시형 코스",
        ...
        "food_area": "세종 정부청사 인근 상권",
        "food_menu": "장원갑칼국수(미나리 칼국수), 스테이인터뷰 나성(브런치 카페)"
    }
}
...
mbti_questions = [
    # E/I
    ("다른 사람들과 만날 때 어떤가요?", "에너지 충전! (E)", "조금 피곤해요.. (I)", "EI"),
    ("모임 후, 더 활기찬가요?", "그렇다 (E)", "아니다 (I)", "EI"),
    ("낯선 사람과 대화가", "재미있다 (E)", "부담스럽다 (I)", "EI"),
    # S/N
    ("여행 계획은?", "세부적으로 짬 (S)", "대충 큰 그림만 (N)", "SN"),
    ("친구의 지시 설명을", "그대로 따라함 (S)", "창의적으로 응용 (N)", "SN"),
    ("새로운 기술 배울 때", "매뉴얼부터 본다 (S)", "바로 시도해봄 (N)", "SN"),
    # T/F
    ("과제 팀원 평가 때", "결과/효율 중시 (T)", "분위기/관계 중시 (F)", "TF"),
    ("친구 고민 상담", "해결책 조언 (T)", "위로·공감 (F)", "TF"),
    ("여행 실제 계획할 때", "효율적 동선! (T)", "동행자 감정 배려 (F)", "TF"),
    # J/P
    ("준비물 챙기기", "미리 철저히 체크 (J)", "즉흥적으로 챙김 (P)", "JP"),
    ("모르는 곳 갈 때", "동선 미리 파악 (J)", "가면서 결정 (P)", "JP"),
    ("급작스러운 계획 변경", "당황/불편함 (J)", "변화 재밌음! (P)", "JP"),
]
...
# -------------------------------
st.set_page_config(page_title="MBTI 국내 여행+맛집 챗봇", page_icon="🧳", layout="centered")
st.title("🧳 MBTI 국내 여행 + 맛집 챗봇")

st.write("간단한 MBTI 테스트를 하고, 결과에 맞는 **국내 여행지와 맛집 존/메뉴**를 추천해 줍니다.")
...
if st.session_state.step == "intro":
    st.subheader("1. MBTI 간이 테스트 시작하기")
    st.write("총 12문항, 각 문항마다 A/B 중 하나를 고르면 됩니다.")
    ...
    with col1:
        if st.button("테스트 시작"):
            ...
            st.rerun()
    with col2:
        mbti_direct = st.text_input("이미 MBTI를 알고 있다면 바로 입력 (예: ENFP)")
        if st.button("MBTI로 바로 추천 보기") and mbti_direct:
...
# test 단계
    ...
    if q_idx < len(mbti_questions):
        ...
        st.subheader(f"질문 {q_idx+1} / {len(mbti_questions)}")
        st.write(q)
...
# result 단계
    ...
    st.markdown("---")
    st.write("다시 테스트를 하거나, 다른 MBTI로도 추천을 받아볼 수 있어요.")
    col1, col2 = st.columns(2)
    with col1:
        if st.button("다시 테스트하기"):
            ...
            st.rerun()
    with col2:
        other = st.text_input("다른 MBTI로 추천 받아보기 (예: ISTP)", key="other_mbti")
        if st.button("다른 MBTI 추천 보기") and other:
            st.markdown("---")
